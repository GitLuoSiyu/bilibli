	...
	<view class="bg-light" style="min-height: 100vh;">
		...
		<block v-for="(item, index) in list" :key="index">
			...
			<view v-else class="bg-white">
				...
				<view v-if="item.video" class="flex align-center justify-center font border-bottom border-top" hover-class="bg-light" style="height: 100rpx;" @click="upload(item)">点击切换视频</view>
				<form-item label="标题">
		...
		<!--  -->
		<view class="flex justify-center align-center bg-main text-white font" style="height: 100rpx;" hover-class="bg-main-hover">
			+ 添加新章节
		</view>
