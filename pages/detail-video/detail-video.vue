		...
		<scroll-view scroll-y="true" :style="'height:' + scrollH + 'px;'">
			<view class="border-bottom border-light-secondary flex align-stretch bg-white" style="height: 80rpx;position: fixed;left: 0;right: 0;z-index: 100;">
				<view class="flex-1 flex align-center justify-center" v-for="(item, index) in tabBars" :key="index" @click="changeTab(index)">
					<text class="font py-1" :class="tabIndex === index ? 'text-main border-main' : ''" :style="tabIndex === index ? 'border-bottom: 5rpx solid;' : ''">
						{{ item.name }}
					</text>
				</view>
			</view>
			...
			<view v-if="tabIndex === 0" class="animated fadeIn fast">
				<view class="py-2 px-3 flex align-center">
					...
					<view class="flex align-center justify-center rounded bg-main text-white py-1 px-2 ml-auto" hover-class="bg-main-hover"><text class="font">关注</text></view>
				</view>
				<view class="font-md px-3">视频标题</view>
				...
				<view class="py-3 border-top border-bottom border-light-secondary">
					...
					<scroll-view scroll-x="true" class="scroll-row mt-2">
						<view
							...
							:class="i === 0 ? 'text-main border-main' : 'text-muted border-light-secondary'"
							style="width: 340rpx;"
						>
			...
			<view v-else class="animated fadeIn fast px-3 py-1">
				<view class="uni-comment-list">
					<view class="uni-comment-face"><image src="/static/demo/6.jpg" style="width: 80rpx;height: 80rpx;" class="rounded-circle"></image></view>
					<view class="uni-comment-body">
						<view class="uni-comment-top"><text class="font text-main">昵称</text></view>
				...
				<view
					class="position-fixed flex align-center justify-center bg-main rounded-circle animated fast"
					hover-class="bg-main-hover pulse"
