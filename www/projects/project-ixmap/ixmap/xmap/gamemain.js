...
function GameMain(game){
  "use strict";
    ...
    this.create = function(){
      ...
      map.createSpriteOnTiles( mapLayer, [17,18,19], "mapitems", [0,1,2], iGroup);
      iGroup.setAll("anchor.x",0.23);
      iGroup.setAll("anchor.y",0.62);
      ...
      hero = iGroup.addChild(new PhaserX.HeroSprite(this.game, pos.x, pos.y, "nigel"));
      ...
      wolf = iGroup.addChild(new PhaserX.NPCSprite(this.game, pos.x, pos.y, "npc-2"));
    ...
    this.render = function(){
      ...
      game.debug.text("MAP:"+this._iData.maps[this._iData.currMap].name, 10, 20);
      game.debug.text("POS:"+pos.x+","+pos.y, 10, 40);
  
      //game.debug.text("iGroup:"+iGroup.children.length, 10, 60);
    };
